...
behaviors:
  RollerBall:
    ...
    hyperparameters:
      ...
      buffer_size: 100    /* Настраивает число необходимого опыта для обновления модели поведения. */
    ...
    reward_signals:
      extrinsic:
        ...
        strength: 1.0    /* Заданное коэффициент, на который умножается поощерение. */
